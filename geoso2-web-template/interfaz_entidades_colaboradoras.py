...
class EntidadesWindow(tk.Toplevel):
    ...
    def save_json(self):
        ...
        try:
            ...
            datos_completos["web"].setdefault("Entidades-colaboradoras", {})
            datos_completos["web"]["Entidades-colaboradoras"]["entidades"] = self.state["entidades"]
